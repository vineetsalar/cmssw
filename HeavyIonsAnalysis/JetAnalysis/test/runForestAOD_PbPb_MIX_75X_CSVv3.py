...
#this is to add a new JetTags (need changes in HiInclusiveJetAnalyzer.cc)
#process.load('RecoBTag.CSVscikit.csvscikitTagJetTags_cfi')
#process.load('RecoBTag.CSVscikit.csvscikitTaggerProducer_cfi')
...
#process.CSVscikitTags.weightFile=cms.FileInPath('HeavyIonsAnalysis/JetAnalysis/data/TMVA_weights2.xml')
